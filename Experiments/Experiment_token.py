...
generator = TokenTextGenerator(text_blocks=[''.join(get_paper_abstract())])
...
if __name__ == '__main__' and ui and not is_evolution_mode():
    ...
    add_recorders(net)
    train_and_generate_text(net, input_steps=260000, recovery_steps=10000, free_steps=5000, sm=sm)#260000
